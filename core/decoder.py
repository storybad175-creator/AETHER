...
from config.fields import RESPONSE_FIELD_MAP
...
def decode_player_data(raw_encrypted: bytes) -> PlayerData:
    ...
    try:
        ...
        # raw_msg will be a dict of dicts if Strategy B recursive decoding worked
        ...
        cosmetics = {
            ...
            "equipped_outfit_ids": safe_get(cosm_raw, 705, []),
            "equipped_weapon_skin_ids": safe_get(cosm_raw, 706, [])
        }
        ...
        raise FFError(ErrorCode.DECODE_ERROR, f"Failed to decode player data: {str(e)}")
