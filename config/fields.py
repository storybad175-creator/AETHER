...
FLD_SOC_LEADER_UID = 506
FLD_SOC_LEADER_NAME = 507
FLD_SOC_LEADER_LEVEL = 508
FLD_SOC_LEADER_RANK = 509
...
# Response Field ID Map for Strategy B
RESPONSE_FIELD_MAP = {
    FLD_ACCOUNT: "account",
    FLD_ACC_UID: "uid",
    ...
    FLD_ACC_SEASON: "season_id",
    FLD_ACC_MODE: "preferred_mode",
    FLD_ACC_LANG: "language",
    FLD_ACC_SIGNATURE: "signature",
    FLD_ACC_HONOR: "honor_score",
    FLD_ACC_LIKES: "total_likes",
    FLD_ACC_OB_VER: "ob_version",
    FLD_ACC_CREATED: "created_at_epoch",
    FLD_ACC_LOGIN: "last_login_epoch",
    ...
    FLD_SOC_LEADER_UID: "guild_leader_uid",
    FLD_SOC_LEADER_NAME: "guild_leader_nickname",
    FLD_SOC_LEADER_LEVEL: "guild_leader_level",
    FLD_SOC_LEADER_RANK: "guild_leader_rank",
